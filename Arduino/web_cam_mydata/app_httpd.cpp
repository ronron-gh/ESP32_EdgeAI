...
void *_context = NULL;    //NNABLA

#if 0   //元々入っていた顔認識を削除し、プログラムをサイズダウン
...
static esp_err_t stream_handler(httpd_req_t *req){
    ...
    int64_t fr_encode = 0;
    uint8_t resized_img[NNABLART_VALIDATION_INPUT0_SIZE];   //NNABLA
    ...
    float *nn_input_buffer = nnablart_validation_input_buffer(_context, 0);     //NNABLA
